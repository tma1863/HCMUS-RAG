...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--embedding-model-name", type=str, default="GritLM/GritLM-7B",
        help="Specify the embedding model name (e.g., text-embedding-3-small, nvidia/NV-Embed-v2, GritLM/GritLM-7B, facebook/contriever)"
    )
    ...
    for dataset_style in dataset_styles:
        ...
        all_paragraphs = open_end_qa_ds["paragraphs"].tolist()
        gold_docs = []
